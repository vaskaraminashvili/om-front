        ...
        <footer>
            ...
            <div class="bg-primary py-3">
                <div class="container">
                    <div class="row align-items-center  custom-text-color">
                        ...
                        <div class="col-lg-5">
                            <div class="mb-6">
                                <a href="{{ route('home') }}" class="d-inline-block">
                                   <img src="{{asset('assets/img/lenti.png')}}" width="500" alt="">
                                </a>
                            </div>
                            <div class="mb-4">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col pl-3">
                                        ...
                                        <a href="tel:+80080018588" class="font-size-20 custom-text-color">(800) 8001-8588, </a><a href="tel:+0600874548" class="font-size-20 custom-text-color">(0600) 874 548</a>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-4">
