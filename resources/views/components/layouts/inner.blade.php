                        ...
                        <div class="row align-items-center">
                                            ...
                                            <div class="u-header-sidebar__footer-offset pb-0">
                                                ...
                                                <div class="position-absolute top-0 right-0 z-index-2 pt-4 pr-7">
                                                    <button type="button" class="close ml-auto"
                                                        ...
                                                        data-unfold-animation-out="fadeOutLeft"
                                                        data-unfold-duration="500">
                                                        <span aria-hidden="true"><i class="ec ec-close-remove custom-text-color font-size-20"></i></span>
                                                    </button>
                                                </div>
                                                <!-- End Toggle Button -->
                                        ...
                                        <ul class="navbar-nav u-header__navbar-nav">
                                            ...
                                            <li class="nav-item hs-has-sub-menu u-header__nav-item"
                                                ...
                                                <ul id="HomeSubMenu" class="hs-sub-menu u-header__sub-menu animated fadeOut" aria-labelledby="HomeMegaMenu" style="min-width: 230px; display: none;">
                                                    ...
                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="../home/home-v8.html">Home v8</a></li>
                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="../home/home-v9.html">Home v9</a></li>
                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="../home/home-v10.html">Home v10</a></li>
                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="../home/home-v11.html">Home v11</a></li>
                                                </ul>
                                                <!-- End Home - Submenu -->
                                            </li>
                                            <!-- End Home -->
                                                    ...
                                                    <div class="row u-header__mega-menu-wrapper">
                                                        <div class="col-md-3">
                                                            ...
                                                            <ul class="u-header__sub-menu-nav-group">
                                                                ...
                                                                <li><a href="../home/home-v8.html" class="nav-link u-header__sub-menu-nav-link">Home v8</a></li>
                                                                <li><a href="../home/home-v9.html" class="nav-link u-header__sub-menu-nav-link">Home v9</a></li>
                                                                <li><a href="../home/home-v10.html" class="nav-link u-header__sub-menu-nav-link">Home v10</a></li>
                                                                <li><a href="../home/home-v11.html" class="nav-link u-header__sub-menu-nav-link">Home v11</a></li>
                            ...
                            <div class="d-none d-xl-block col-md-auto">
                                <div class="d-flex">
                                    ...
                                    <div class="ml-2">
                                        <div class="phone">
                                            <strong>Support</strong> <a href="tel:800856800604" class="custom-text-color">(+800) 856 800 604</a>
                                        </div>
                                        <div class="email">
                                            E-mail: <a href="mailto:info@electro.com?subject=Help Need" class="custom-text-color">info@electro.com</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card border-0 rounded-0">
                                            <div class="card-header bg-primary rounded-0 card-collapse border-0" id="basicsHeadingOne">
                                                <button type="button" class="btn-link btn-remove-focus btn-block d-flex card-btn py-3 text-lh-1 px-4 shadow-none btn-primary rounded-top-lg border-0 font-weight-bold custom-text-color"
                                                    ...
                                                    <span class="pl-1 custom-text-color">Shop By Department</span>
                                                    <span class="custom-text-color ml-3">
                            ...
                            <div class="col-md-auto align-self-center">
                                <div class="d-flex">
                                    <ul class="d-flex list-unstyled mb-0">
                                        <li class="col"><a href="../shop/compare.html" class="custom-text-color" data-toggle="tooltip" data-placement="top" title="Compare"><i class="font-size-22 ec ec-compare"></i></a></li>
                                        <li class="col"><a href="../shop/wishlist.html" class="custom-text-color" data-toggle="tooltip" data-placement="top" title="Favorites"><i class="font-size-22 ec ec-favorites"></i></a></li>
                                        <li class="col pr-0">
                                            <a href="../shop/cart.html" class="custom-text-color position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                                <i class="font-size-22 ec ec-shopping-bag"></i>
                                                ...
                                                <span class="font-weight-bold font-size-16 custom-text-color ml-3">$1785.00</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="u-sidebar__content u-header-sidebar__content px-4">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="border-bottom pb-4 mb-4">
                                        ...
                                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="brandAdidas1">Adidas
                                        ...
                                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="brandNewBalance2">New Balance
                                                    <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="brandNike3">
                                                <label class="custom-control-label" for="brandNike3">Nike
                                                    <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="brandFredPerry3">
                                                <label class="custom-control-label" for="brandFredPerry3">Fred Perry
                                                    <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="brandTnf2">
                                                <label class="custom-control-label" for="brandTnf2">The North Face
                                                    <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="collapse" id="collapseBrand">
                                            <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="brandGucci3">Gucci
                                                        <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="brandMango2">Mango
                                                        <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="border-bottom pb-4 mb-4">
                                        ...
                                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="categoryTshirt1">
                                                <label class="custom-control-label" for="categoryTshirt1">Black <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                                            </div>
                                        </div>
                                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="categoryShoes1">
                                                <label class="custom-control-label" for="categoryShoes1">Black Leather <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                                            </div>
                                        </div>
                                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="categoryAccessories1">
                                                <label class="custom-control-label" for="categoryAccessories1">Black with Red <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                                            </div>
                                        </div>
                                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="categoryTops2">
                                                <label class="custom-control-label" for="categoryTops2">Gold <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                                            </div>
                                        </div>
                                        <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="categoryBottom1">
                                                <label class="custom-control-label" for="categoryBottom1">Spacegrey <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                                            </div>
                                        </div>
                                        <!-- End Checkboxes -->
                                        ...
                                        <div class="collapse" id="collapseColor">
                                            <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="categoryShorts1">
                                                    <label class="custom-control-label" for="categoryShorts1">Turquoise <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                                                </div>
                                            </div>
                                            <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="categoryHats1">
                                                    <label class="custom-control-label" for="categoryHats1">White <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                                                </div>
                                            </div>
                                            <div class="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="categorySocks1">
                                                    <label class="custom-control-label" for="categorySocks1">White with Gold <span class="text-gray-25 font-size-12 font-weight-normal"> (56)</span></label>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End View More - Collapse -->
