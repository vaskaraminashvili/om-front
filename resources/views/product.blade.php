          ...
          <div class="row">
              <div class="col-md-5 mb-4 mb-md-0">
                  <div id="sliderSyncingNav" class="js-slick-carousel u-slick mb-2"
                      ...
                      <div class="js-slide">
                          <img class="img-fluid" src="{{asset('/assets/img/1024X1024/img'.rand(1,3).'.jpg')}}" alt="Image Description">
                      </div>
                      <div class="js-slide">
                          <img class="img-fluid" src="{{asset('/assets/img/1024X1024/img'.rand(1,3).'.jpg')}}" alt="Image Description">
                      </div>
                  ...
                  <div class="mb-2">
                      <div class="border-bottom mb-3 pb-md-1 pb-3">
                          ...
                          <div class="d-md-flex align-items-center">
                              <a href="#" class="max-width-150 ml-n2 mb-2 mb-md-0 d-block"><img class="img-fluid" src="{{asset('/assets/img/200X60/img1.png')}}" alt="Image Description"></a>
                  ...
                  <div class="tab-pane fade" id="Jpills-two-example1" role="tabpanel" aria-labelledby="Jpills-two-example1-tab">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6 text-right">
                              <img class="img-fluid mr-n4 mr-lg-n10" src="{{asset('/assets/img/580X580/img1.jpg')}}" alt="Image Description">
                          </div>
                          <div class="col-md-6 text-left">
                              <img class="img-fluid ml-n4 ml-lg-n10" src="{{asset('/assets/img/580X580/img2.jpg')}}" alt="Image Description">
                          </div>
